...
<td>".$country->fullname." </td><td><A href='continentDetails.php?id=".$country->continent->id."'/>".$country->continent->name."</A></td><td><A href='regionDetails.php?id=".$country->region->id."'/>".$country->region->name."</A></td><td><img src='../flags/16x16/".strtolower($country->codeiso2).".png'/></td><td><A href='countryDetails.php?id=".$country->id."'>Detail</A></td></tr>";
				}?>
				</tbody>
				</table>
			</div>
